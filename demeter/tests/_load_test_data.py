    ...
    for farm in field_bounds[field_bounds["owner"] == owner]["farm"].unique():
        ...
        for i, row_fb in field_bounds[field_bounds["farm"] == farm].iterrows():
            ...
            for i, row_ap in as_planted[
                ...
                crop = row_ap["crop"].lower() if not pd_isnull(row_ap["crop"]) else None
                product_name = (
...
# %%  Add as-planted records
# from os.path import join
# from pathlib import Path

# DIR = "/mnt/c/Users/Tyler/Downloads"

# field_bounds = read_file(Path(join(DIR, "nvd_field-bounds_2022.geojson")))
# as_planted = read_file(Path(join(DIR, "nvd_as-planted_2022.geojson")))
