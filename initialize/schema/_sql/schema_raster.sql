...
-- give `demeter_ro_user` read access to `raster`
grant select on all tables in schema raster to demeter_ro_user;
grant select on all sequences in schema raster to demeter_ro_user;
grant usage on schema raster to demeter_ro_user;

-- give `raster_user` read and write access to `raster`
...
-- give `raster_ro_user` read access to `raster`
